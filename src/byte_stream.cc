...
// {
//     // Your code here.
//     size_t size = min(data.size(), capacity_ - buffer.size());
...
//     // Your code here.
//     const std::size_t size = min(len, buffer.size());
...
{
  // Your code here.
  size_t size = min(data.length(), capacity_ - buffer.size());
  data = data.substr(0, size);
...
{
  // Your code here.
  size_t size = min(len, buffer.size());
  // buffer.erase(buffer.begin(), buffer.begin() + size);
